...
public class DatastoreFactory {
	...
	public static Datastore getDatastore(Datastore ds)
	{
		...
		((DatastoreImpl)result).getMapper().getConverters().addConverter(new BigDecimalConverter());
		((DatastoreImpl)result).getMapper().getConverters().addConverter(new BigIntegerConverter());
